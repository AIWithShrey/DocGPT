...
function fetchParameters() {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var accessId, accessIdResponse, envContent, formattedEnv, error_1;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 2, , 3]);
                    accessId = new client_ssm_1.GetParameterCommand({
                        Name: "accessId",
                        WithDecryption: true
                    });
                    return [4 /*yield*/, ssmClient.send(accessId)];
                case 1:
                    accessIdResponse = _c.sent();
                    envContent = "\n      REACT_APP_SECRET_ACCESS_KEY=".concat((_a = accessIdResponse.Parameter) === null || _a === void 0 ? void 0 : _a.Value, "\n      REACT_APP_ACCESS_KEY=").concat((_b = accessIdResponse.Parameter) === null || _b === void 0 ? void 0 : _b.Value, "\n        ");
